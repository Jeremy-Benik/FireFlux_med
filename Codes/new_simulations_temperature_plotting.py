...
file_1 = nc.Dataset('/home/jbenik/fireflux_med/simulations/10_01_22_smooth_sodar_20_min_ws_averages_6m_ext_03_z0/wrfout_d01_2013-01-30_14:50:00')
file_2 = nc.Dataset('/home/jbenik/fireflux_med/simulations/10_01_22_smooth_sodar_20_min_ws_averages_6m_ext_03_z0/wrfout_d01_2013-01-30_15:06:40')
...
print('Getting t from the first wrfout file')
t_main_1 = wrf.getvar(file_1, "tc", None)[:, :, :, :]
print('Getting t from the second wrfout file')
...
# %%
t_main = np.concatenate((t_main_1, t_main_2), axis = 0)
...
out_path = 'pickle_files/original_sounding_pickle_files/10_01_22_un_mod_avg_20_min_sim_match_FF2_main_tower_Temperature_smooth_sodar.pkl'
...
file_1 = nc.Dataset('/home/jbenik/fireflux_med/simulations/10_01_22_smooth_sodar_modified_20_min_ws_averages_6m_ext_03_z0/wrfout_d01_2013-01-30_14:50:00')
file_2 = nc.Dataset('/home/jbenik/fireflux_med/simulations/10_01_22_smooth_sodar_modified_20_min_ws_averages_6m_ext_03_z0/wrfout_d01_2013-01-30_15:06:40')
# file_3 = nc.Dataset('/home/jbenik/fireflux_med/simulations/modified_heat_extinction_input_sounding/wrfout_d01_2013-01-30_15:13:01')
# file_4 = nc.Dataset('/home/jbenik/fireflux_med/simulations/modified_heat_extinction_input_sounding/wrfout_d01_2013-01-30_15:29:41')
...
# %% Getting the variables and storing them in a pickle file
out_path = 'pickle_files/modified_sounding_pickle_files/10_01_22_mod_avg_20_min_sim_main_tower_Temperature_smooth_sodar.pkl'
if not osp.exists(out_path):
...
file_1 = nc.Dataset('/home/jbenik/fireflux_med/simulations/10_01_22_modified_20_min_averages_match_ff2_sim/wrfout_d01_2013-01-30_14:50:00')
file_2 = nc.Dataset('/home/jbenik/fireflux_med/simulations/10_01_22_modified_20_min_averages_match_ff2_sim/wrfout_d01_2013-01-30_15:06:40')
# file_3 = nc.Dataset('/home/jbenik/fireflux_med/simulations/modified_heat_extinction_input_sounding/wrfout_d01_2013-01-30_15:13:01')
# file_4 = nc.Dataset('/home/jbenik/fireflux_med/simulations/modified_heat_extinction_input_sounding/wrfout_d01_2013-01-30_15:29:41')
...
# %% Getting the variables and storing them in a pickle file
out_path = 'pickle_files/fit_FF2_sims/10_01_22_mod_avg_20_min_sim_match_FF2_main_tower_Temperature_smooth_sodar.pkl'
if not osp.exists(out_path):
...
locals().update(results)
# %% Mmodified Sounding
out_path = 'pickle_files/modified_sounding_pickle_files/10_01_22_modified_avg_20_min_sim_main_tower_Temperature_smooth_sodar.pkl'
with open(out_path, 'rb') as f:
    results = pickle.load(f)
locals().update(results)
# %% FF2 Simulation
out_path = 'pickle_files/fit_FF2_sims/10_01_22_modified_avg_20_min_sim_match_FF2_main_tower_Temperature_smooth_sodar.pkl'
with open(out_path, 'rb') as f:
    results = pickle.load(f)
locals().update(results)
...
n = 50
plt.suptitle('Modified input_sounding. 6m ext, 0.3z0 /home/jbenik/fireflux_med/simulations/10_01_22_smooth_sodar_modified_20_min_ws_averages_6m_ext_03_z0', fontsize = 10, fontweight = 'bold')
# 5.33 Meter plot
