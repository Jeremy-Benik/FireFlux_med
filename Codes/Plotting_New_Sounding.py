...
ws_new_new = df['ws_new_new']
ht_new_new = df['ln_ht']

ws_old_old = df['ws_old_old']
ht_old_old = df['ln_ht_old']
# %%
fig, ax = plt.subplots(1, 2, figsize = (12, 10))

ax[0].plot(ws_old_old, ht_old_old, color = 'blue', label = 'Wind Speed')
...
ax[1].plot(ws_new_new, ht_new_new, color = 'blue', label = 'Wind Speed')
